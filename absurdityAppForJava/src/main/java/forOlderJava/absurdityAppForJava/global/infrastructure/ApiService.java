package forOlderJava.absurdityAppForJava.global.infrastructure;

import forOlderJava.absurdityAppForJava.global.exception.ExternalApiException;
...
public class ApiService {
    ...
    private <T> ResponseEntity<T> callExternalApi(String url, HttpEntity httpEntity, Class<T> clazz, Map<String, ?> uriVariables) {
        try {
