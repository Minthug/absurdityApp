...
public record FindNewItemsCommand(Long lastIdx, Long lastItemId, PageRequest pageRequest, ItemSortType itemSortType) {

    private static final int DEFAULT_PAGE_NUMBER = 0;

    public static FindNewItemsCommand of(Long lastIdx, Long lastItemId, int pageSize, String sortType) {
