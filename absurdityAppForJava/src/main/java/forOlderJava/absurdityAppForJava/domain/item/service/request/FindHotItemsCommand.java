...
public record FindHotItemsCommand(Long lastIdx, Long lastItemId, PageRequest pageRequest, ItemSortType itemSortType) {

    public static final int DEFAULT_PAGE_NUMBER = 0;

    public static FindHotItemsCommand of(Long lastIdx, Long lastItemId, int pageSize, String sortType) {
